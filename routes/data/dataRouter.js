 ...
 * @endpoint http://localhost:3000/data/new-data
 * @example same
 */
 ...
 * @endpoint http://localhost:3000/data/get-all/:table/:field
 * @example http://localhost:3000/data/get-all/todo_table/id
 */
 ...
 * @endpoint http://localhost:3000/data/get-all/:table/:field/:page
 * @example http://localhost:3000/data/get-all/todo_table/id/2
 */
//http://localhost:3000/v1/get-all/:table/:field/:page (user_table)(id)(page no.=2)
